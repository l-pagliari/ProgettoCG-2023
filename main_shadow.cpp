...
int main()
{
    ...
    {
        glm::vec3(-2.5f, 0.0f, -0.48f),
        glm::vec3( 2.5f, 0.2f,  0.51f),
        glm::vec3(-3.3f, 0.3f, -2.3f),
        glm::vec3 (0.2f, 0.4f, 2.6f)
    };
...
// renderPlane() renders a 25x25 plane
// -----------------------------------
...
// renderWindow() renders a 1x1 vertical quad
// ------------------------------------------
...
/* funzione che gestisce gli input della window letti ad ogni frame */
void processInput(GLFWwindow *window)
{
...
{
    // camera rotates only if mouse button left is pressed
    if(mouse_dragged == false) return;
